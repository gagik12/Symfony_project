...
abstract class BaseUserPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Login', 'Password', 'Name', 'LastName', 'Role', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'login', 'password', 'name', 'lastName', 'role', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::LOGIN, self::PASSWORD, self::NAME, self::LAST_NAME, self::ROLE, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'login', 'password', 'name', 'last_name', 'role', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Login' => 1, 'Password' => 2, 'Name' => 3, 'LastName' => 4, 'Role' => 5, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'login' => 1, 'password' => 2, 'name' => 3, 'lastName' => 4, 'role' => 5, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::LOGIN => 1, self::PASSWORD => 2, self::NAME => 3, self::LAST_NAME => 4, self::ROLE => 5, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'login' => 1, 'password' => 2, 'name' => 3, 'last_name' => 4, 'role' => 5, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
	);
